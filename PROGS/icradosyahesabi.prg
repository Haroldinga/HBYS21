...
DO CASE
	CASE VARTYPE(tuParameter) = T_Object
		** loIcraDosyaVal gönderilmiþ, Icradosyabizobj ye gerek yok
		loIcraDosyaVal = tuParameter
		lcIcraDosya_Id = loIcraDosyaVal.IcraDosya_Id
	CASE VARTYPE(tuParameter) = T_Character  && IcraDosya_Id Gönderilmiþ.. Ýçeriðine Versiyon20 den bakabilirsin
		llreturn = .F.
	OTHERWISE
		llreturn = .F.
ENDCASE
